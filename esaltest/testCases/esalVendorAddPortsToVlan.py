...
VendorAddPortsToVlan 75 3 [29,30,5]
...
tcFlushStr = '''
VendorDeletePortsFromVlan 75 4 [28,29,30,5]
VendorDeleteVlan 75
'''
...
expectedData = {
        'expect1':'intVendorGetPortsInVlan(uint16_t,uint16_t*,uint16_t*)75rc:0numPorts:4ports:[28,29,30,5,0]vlanId:75'
}
