...
tcParams = {
    ...
    'tcName' : 'esalVendorTagPacketsOnIngress',
    'description' : 'TC to check esal attributes VendorTagPacketsOnIngress, VendorStripTagsOnEgress',
    'ingressPort' : ['29'],
    'egressPort' : ['28', '30'],
    'pktAction' : 'FORWARD',
    'ingressTapIntf' : 'tap1',
...
tcFlushStr = '''
VendorResetPort 29
VendorDeletePortsFromVlan 75 3 [28,29,30]
VendorDeleteVlan 75
'''

packet_info = scapy_t.Ether(src="00:00:11:00:11:00",dst="00:00:11:00:11:23")/scapy_t.IP()
